...
const FooterLinks = ({ heading, items }) => {
  <div className='flex-1 justify-start items-start'>
    ...
    {items.map((item, index) => (
      <p className='font-poppins dark:text-while text-nft-black-1 font-normal text-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-black-1 my-3'>{item}</p>
    ))}
  </div>
}
const Footer = () => {
